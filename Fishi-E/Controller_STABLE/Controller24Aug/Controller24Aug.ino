/* 
 *  The controller code from Aug 24, 2022
...
//  pinMode(A5, INPUT);
  ...
  pinMode(home_msg,OUTPUT);
  pinMode(kill_msg,OUTPUT);
}
  ...
  display.clearDisplay();
   ...
   // send command
    if (millis() - timer1 > 100) {
      ...
      if (killed == true){
        digitalWrite(kill_msg, HIGH);
        pMap = 0;
      } else {
        digitalWrite(kill_msg, LOW);
      }
